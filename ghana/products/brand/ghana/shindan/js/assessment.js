...
function restartHide(){
	...
	$("#current_value4, #q4_txt, #choices4").hide();
	$("#current_value5, #q5_txt, #choices5").hide();
	$("#question1, #question2, #question3, #question4, #question5").css({'top':'55px','opacity':'0'});
	$("#q1pkg, #q2pkg, #q3pkg, #q4pkg, #q5pkg").css({'top':'70px','opacity':'0'});
	clearInterval(timerId);
}

function backHide(){
	$("#result, #back_btn, #top").hide();
	$("#current_value1,#current_value2,#current_value3,#current_value4,#current_value5").fadeOut(200);
	$("#question1, #question2, #question3, #question4, #question5").css({'opacity':'0','top':'55px'});
	$("#q1pkg, #q2pkg, #q3pkg, #q4pkg, #q5pkg").css({'top':'70px','opacity':'0'});
...
function q1In(){
	$("#question, #Q1, #current_value1").fadeIn(500);
	$("#top, #back_btn, #restart").fadeOut(200);
	
	setTimeout(question1Tit,600);
	setTimeout(question1Txt,1000);
	setTimeout(question1Choices,1400);
	function question1Tit(){
		$("#question1").animate({"top":75,opacity:1}, 400);
		$("#q1pkg").animate({"top":90,opacity:1}, 400);
	}
	
	clearInterval(timerId);
	zuizui();
	
	function question1Txt(){ $("#q1_txt").fadeIn(400); }
	function question1Choices(){ $("#choices1").fadeIn(400); }
}

function q2In(){
	$("#Q2, #current_value2, #restart").fadeIn(500);
	$("#Q1, #back_btn").fadeOut(500);
	...
	function question2Tit(){
		$("#question2").animate({"top":75,opacity:1}, 400);
		$("#q2pkg").animate({"top":90,opacity:1}, 400);
	}
	
	clearInterval(timerId);
	zuizui();
	
	function question2Txt(){ $("#q2_txt").fadeIn(400); }
	function question2Choices(){ $("#choices2").fadeIn(400); }
	function question2bb(){ $("#back_btn").fadeIn(400); }
}

function q3In(){
	$("#Q3, #current_value3").fadeIn(500);
	$("#Q2, #back_btn").fadeOut(500);
	...
	function question3Tit(){
		$("#question3").animate({"top":75,opacity:1}, 400);
		$("#q3pkg").animate({"top":90,opacity:1}, 400);
	}
	
	clearInterval(timerId);
	zuizui();
	
	function question3Txt(){ $("#q3_txt").fadeIn(400); }
	function question3Choices(){ $("#choices3").fadeIn(400); }
	function question3bb(){ $("#back_btn").fadeIn(400); }
}

function q4In(){
	$("#Q4, #current_value4").fadeIn(500);
	$("#Q3, #back_btn").fadeOut(500);
	...
	function question4Tit(){
		$("#question4").animate({"top":75,opacity:1}, 400);
		$("#q4pkg").animate({"top":90,opacity:1}, 400);
	}
	
	clearInterval(timerId);
	zuizui();
	
	function question4Txt(){ $("#q4_txt").fadeIn(400); }
	function question4Choices(){ $("#choices4").fadeIn(400); }
	function question4bb(){ $("#back_btn").fadeIn(400); }
}

function q5In(){
	$("#Q5, #current_value5").fadeIn(500);
	$("#Q4, #back_btn").fadeOut(500);
	...
	function question5Tit(){
		$("#question5").animate({"top":75,opacity:1}, 400);
		$("#q5pkg").animate({"top":90,opacity:1}, 400);
	}
	
	clearInterval(timerId);
	zuizui();
	
	function question5Txt(){ $("#q5_txt").fadeIn(400); }
	function question5Choices(){ $("#choices5").fadeIn(400); }
	function question5bb(){ $("#back_btn").fadeIn(400); }
}

function resultIn(){
	$("#result, #result_index_r, #restart02").fadeIn(500);
	$("#question, #Q5, #back_btn").fadeOut(500);
	$("#back_btn").off("click");
	$("#restart02").off("click");
	$("#restart02").on("click",function(){ restartHide(); q01(); });
}
